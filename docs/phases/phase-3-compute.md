...
| `expected_client_cn` | `string` | Expected client cert CN (default: `"mcp-client.your-domain.com"`) |
...
11. Smoke test the Lambda directly:
    ...
    aws lambda invoke --function-name engram-memory-handler \
      --payload '{"requestContext":{"http":{"path":"/store"}},"headers":{"x-amzn-mtls-clientcert-subject":"CN=mcp-client.your-domain.com"},"body":"{\"text\":\"test memory\",\"scope\":\"global\",\"conversation_id\":\"test-1\"}"}' \
      /tmp/response.json
...
aws lambda invoke --function-name engram-memory-handler \
  --payload '{"requestContext":{"http":{"path":"/store"}},"headers":{"x-amzn-mtls-clientcert-subject":"CN=mcp-client.your-domain.com"},"body":"{\"text\":\"acceptance test memory\",\"scope\":\"global\",\"conversation_id\":\"acceptance-1\"}"}' \
